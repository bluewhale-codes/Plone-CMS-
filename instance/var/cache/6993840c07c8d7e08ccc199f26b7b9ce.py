# -*- coding: utf-8 -*-
__filename = '/mnt/d/mylinuxprojects/training/backend/venv/lib/python3.10/site-packages/z3c/form/browser/radio_display.pt'
...
def initialize(modules, nothing, tales, zope_version_5_8_5_):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Static value=<ast.Dict object at 0x7fd0782503a0> name=None at 7fd078251750> -> __attrs_140533345621456
            __attrs_140533345621456 = _static_140533345616800
            __append('\n')

            # <Static value=<ast.Dict object at 0x7fd078251c00> name=None at 7fd078251600> -> __attrs_140533345767904
            __attrs_140533345767904 = _static_140533345623040

            # <span ... (0:0)
            # --------------------------------------------------------
            __append('<span')

            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345775968
            __default_140533345775968 = _DEFAULT_MARKER

            # <Substitution 'view/id' (5:25)> -> __attr_id
            __token = 165
            try:
                __zt_tmp = __attrs_140533345767904
            ...
            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345770880
            __default_140533345770880 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345763776
            __default_140533345763776 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345767424
            __default_140533345767424 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345765984
            __default_140533345765984 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345763680
            __default_140533345763680 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345771216
            __default_140533345771216 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345770352
            __default_140533345770352 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345768720
            __default_140533345768720 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345773328
            __default_140533345773328 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345765456
            __default_140533345765456 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345765504
            __default_140533345765504 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345770976
            __default_140533345770976 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fd07c5afbe0> -> __default_140533345769296
            __default_140533345769296 = _DEFAULT_MARKER
            ...
            # <Static value=<ast.Dict object at 0x7fd07c63b280> name=None at 7fd07c63b5b0> -> __attrs_140533345766560
            __attrs_140533345766560 = _static_140533416833664
            __backup_value_140533345838528 = get('value', __marker)

            # <Value 'view/displayValue' (20:18)> -> __iterator
            __token = 851
            try:
                __zt_tmp = __attrs_140533345766560
            except get('NameError', NameError):
                __zt_tmp = None

            __iterator = _static_140533417025280('path', 'view/displayValue', econtext=econtext)(_static_140533417024992(econtext, __zt_tmp))
            (__iterator, ____index_140533345766176, ) = getname('repeat')('value', __iterator)
            econtext['value'] = None
            for __item in __iterator:
                econtext['value'] = __item

                # <Static value=<ast.Dict object at 0x7fd0782765c0> name=None at 7fd0782754b0> -> __attrs_140533345768048
                __attrs_140533345768048 = _static_140533345772992
                ...
                # <Value 'value' (22:24)> -> __cache_140533345763872
                __token = 929
                try:
                    __zt_tmp = __attrs_140533345768048
                except get('NameError', NameError):
                    __zt_tmp = None

                __cache_140533345763872 = _static_140533417025280('path', 'value', econtext=econtext)(_static_140533417024992(econtext, __zt_tmp))

                # <BinOp left=<Value 'value' (22:24)> op=<class 'chameleon.nodes.Is'> right=<Symbol value=<DEFAULT> at 7fd07c5afbe0> at 7fd0782752a0> -> __condition
                __expression = __cache_140533345763872
                ...
                if __condition:
                    ...
                    __content = __cache_140533345763872
                    __content = __quote(__content, None, '\xad', None, None)
                    if (__content is not None):
                        __append(__content)
                __append('</span>')

                # <Static value=<ast.Dict object at 0x7fd07c63b280> name=None at 7fd07c63b5b0> -> __attrs_140533345768864
                __attrs_140533345768864 = _static_140533416833664

                # <Value 'not:repeat/value/end' (23:28)> -> __condition
                __token = 964
                try:
                    __zt_tmp = __attrs_140533345768864
                except get('NameError', NameError):
                    __zt_tmp = None
                ...
                if __condition:
                    __append(', ')
                ____index_140533345766176 -= 1
                if (____index_140533345766176 > 0):
                    __append('')
            if (__backup_value_140533345838528 is __marker):
                del econtext['value']
            else:
                econtext['value'] = __backup_value_140533345838528
            __append('</span>\n\n')
        except:
